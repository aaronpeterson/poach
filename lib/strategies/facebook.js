...
Strategy.prototype.normalizedProfileWithProfileData = function(profileData) {
	return {
		...
		avatarURL: "http://graph.facebook.com/"+ profileData.username +"/picture?width=612&height=612",

		// Passport compatibility
		emails: [{'home': profileData.email}],
		photos: ["http://graph.facebook.com/"+ profileData.username +"/picture?width=612&height=612"]
	}
}
