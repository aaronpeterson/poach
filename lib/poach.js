...
exports.normalizedProfileWithProfileData = function(provider, profileData) {
	if (!_strategies[provider]) {
		throw new error.PoachError('No strategy for '+ provider);
	}

	return _strategies[provider].normalizedProfileWithProfileData(profileData);
}
